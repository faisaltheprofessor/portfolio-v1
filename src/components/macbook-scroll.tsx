...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h[100vh] md:min-h-[200vh]  flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50 mb-[500px] md:mb-10"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white text-light-slate text-3xl font-bold mb-20 text-center"
      >
        {title || (
          <span className="flex gap-x-3 items-center">
            Currently working on <span className="text-green">Intellecta</span>
            <a
              href="https://intellecta.iamfaisal.de/dashboard"
              rel="noopener"
              target="_blank"
              className="text-green hover:-translate-y-1 transition"
            >
              <ExternalLink />
            </a>
            <a
              href="https://github.com/faisaltheprofessor/next-ai-saas.git"
              rel="noopener"
              target="_blank"
              className="text-green hover:-translate-y-1 transition"
            >
...
export const Lid = ({
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        <div className="absolute inset-0 bg-navy rounded-lg p-0" />
        <Image
          src={src as string}
          alt="aceternity logo"
          fill
          className="object-cover object-left-top absolute rounded-lg inset-0 h-full w-full p-0 m-0"
        />
      </motion.div>
    </div>
  );
