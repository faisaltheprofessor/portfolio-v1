        ...
        >
          <div className="w-full lg:w-2/3">
            ...
            >
              ...
              <span className="text-green"> 2015</span> when I decided to create
              a<span className="text-green"> website</span> dedicated to my
            ...
            >
              ...
              allowed me to join forces with diverse organizations in Kabul,
              along with contributing to a thriving startup in Berlin. My
              primary focus in recent times is centered around developing
              projects using Laravel and React (Next.js). These technologies
              have become my main tools for building robust and efficient web
              applications.
            </motion.p>
            ...
            >
              In my recent work, I have had the opportunity to work with
              followin technologies:
            </motion.p>
